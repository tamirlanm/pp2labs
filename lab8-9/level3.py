import pygame, sys
from worm import Snake  # Importing the Snake class from the 'worm' module
...
def level3(score):
    ...
    text = font.render("level1", True, (255, 255, 255))  # Rendering text for display

    apple = (15, 9)  # Initial position of the apple

    walls = [(7, 18), (4, 12), (15, 5), (2, 8), (11, 3), (19, 17), (6, 0), (13, 9)]  # Coordinates of wall blocks
